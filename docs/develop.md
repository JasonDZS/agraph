...
```bash
# 基本语法检查
flake8 agraph/ examples/ --max-line-length=120 --extend-ignore=E203,W503,E501

# 详细检查
flake8 agraph/ examples/ --max-line-length=120 --extend-ignore=E203,W503,E501 --count --statistics
```
