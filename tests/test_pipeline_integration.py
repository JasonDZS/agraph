...
class TestPipelineIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_documents = ["/tmp/test_doc1.txt", "/tmp/test_doc2.pdf"]

    def test_pipeline_builder_initialization(self):
        """Test that pipeline builder initializes correctly."""
        builder = KnowledgeGraphBuilder(config=self.config, enable_knowledge_graph=True)
    ...
    def test_pipeline_factory_creation(self):
        ...
        minimal_pipeline = builder.pipeline_factory.create_minimal_pipeline(
            builder.text_chunker_handler, builder.graph_assembler
        )
    ...
    def test_custom_pipeline_creation(self):
        ...
        custom_pipeline = (
            builder.pipeline_builder.with_text_chunking(builder.text_chunker_handler)
...
class TestMockPipelineExecution(unittest.TestCase):
    ...
    def test_mock_pipeline_execution_success(self):
        ...
        builder = KnowledgeGraphBuilder(config=self.config)
        context = BuildContext(texts=self.test_texts, graph_name="mock_test")
...
class TestPipelineMetrics(unittest.TestCase):
    ...
    def test_pipeline_metrics_collection(self):
        ...
        pipeline = self.builder.pipeline_factory.create_minimal_pipeline(
            self.builder.text_chunker_handler, self.builder.graph_assembler
        )
...
class TestErrorHandling(unittest.TestCase):
    ...
    def test_build_context_validation(self):
        ...
        # Valid context
        valid_context = BuildContext(texts=["test text"], enable_knowledge_graph=True)
