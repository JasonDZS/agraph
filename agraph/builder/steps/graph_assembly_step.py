...
class GraphAssemblyStep(BuildStep):
    ...
    def __init__(self, graph_assembler: GraphAssembler, cache_manager: Any):
        """
    ...
    async def _execute_step(self, context: BuildContext) -> StepResult[KnowledgeGraph]:
        ...
        try:
            ...
            graph_metrics = {
                ...
                "total_text_chunks": (
                    len(knowledge_graph.text_chunks) if hasattr(knowledge_graph, "text_chunks") else 0
                ),
            }
            ...
            if isinstance(knowledge_graph, KnowledgeGraph):
                ...
                if hasattr(knowledge_graph, "get_performance_metrics"):
                    try:
                        ...
                        graph_metrics.update({"performance_metrics": perf_metrics})
                    except Exception:
                ...
                if hasattr(knowledge_graph, "index_manager"):
                    try:
                        index_stats = knowledge_graph.index_manager.get_statistics()
                        graph_metrics.update({"index_statistics": index_stats})
                    except Exception:
            ...
            return StepResult.success_result(knowledge_graph, metadata=graph_metrics)
