...
class ImagePreprocessor:
    ...
    @staticmethod
    def _estimate_quality(total_pixels: int, file_size: int) -> str:
    ...
    def optimize_for_api(
        ...
        try:
            ...
            raise ProcessingError(f"Failed to optimize image {image_path}: {str(e)}")

    @staticmethod
    def batch_optimize_images(
        image_paths: list[Union[str, Path]], output_dir: Optional[Union[str, Path]] = None, **optimization_kwargs: Any
